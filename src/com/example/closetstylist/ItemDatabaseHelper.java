...
public class ItemDatabaseHelper {
	...
	= {
		// String imageLink (null), String color, int tempMin, int tempMax, String category, String cropImageLink (null)
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Blue, 15, 100, ItemCategoryEnum.Bottom, null).name("Banana jean").description("Banana jean").brand("Banana").age(1).material(ItemMaterialEnum.Denim).style(ItemStyleEnum.Jeans).dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultMaleUserProfile),
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Blue, 40, 120, ItemCategoryEnum.Top, null).name("Express polo").description("Express polo").brand("Express").age(2).material(ItemMaterialEnum.Cotton_Or_Cotton_Blend).style(ItemStyleEnum.Polo).dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultMaleUserProfile),
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Multicolor_Pattern, 70, 120, ItemCategoryEnum.Bottom, null).name("DKNY short").description("DKNY short").brand("DKNY").age(1).material(ItemMaterialEnum.Polyester).style(ItemStyleEnum.Shorts).dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultMaleUserProfile),
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Green, 70, 120, ItemCategoryEnum.Bottom, null).name("FrenchConnection short").description("FrenchConnection short").brand("FrenchConnection").age(3).material(ItemMaterialEnum.Cotton_Or_Cotton_Blend).style(ItemStyleEnum.Shorts).dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultMaleUserProfile),
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Multicolor_Pattern, 70, 120, ItemCategoryEnum.Top, null).name("AE t-shirt").description("AE t-shirt").brand("AE").age(2).material(ItemMaterialEnum.Cotton_Or_Cotton_Blend).style(ItemStyleEnum.T_Shirt_Short_Sleeve).dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultMaleUserProfile),
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Yellow, 70, 120, ItemCategoryEnum.Top,null).name("JCrew t-shirt").description("JCrew t-shirt").brand("JCrew").age(1).material(ItemMaterialEnum.Cotton_Or_Cotton_Blend).style(ItemStyleEnum.T_Shirt_Short_Sleeve).dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultMaleUserProfile),
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Blue, 15, 100, ItemCategoryEnum.Bottom, null).name("Arizona jean").description("Arizona jean").brand("Arizona").age(5).material(ItemMaterialEnum.Denim).style(ItemStyleEnum.Jeans).dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultMaleUserProfile),
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Brown, 15, 100, ItemCategoryEnum.Bottom, null).name("Aeropostale pants").description("Aeropostale pants").brand("Aeropostale").age(4).material(ItemMaterialEnum.Cotton_Or_Cotton_Blend).style(ItemStyleEnum.Pants).dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultMaleUserProfile),
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Beige, 15, 100, ItemCategoryEnum.Bottom, null).name("Dockers pants").description("Dockers pants").brand("Dockers").age(3).material(ItemMaterialEnum.Cotton_Or_Cotton_Blend).style(ItemStyleEnum.Pants).dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultMaleUserProfile),
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Multicolor_Pattern, 15, 100, ItemCategoryEnum.Top, null).name("Adidas jacket").description("Adidas jacket").brand("Adidas").age(1).material(ItemMaterialEnum.Polyester).style(ItemStyleEnum.Coat_And_Jacket_Light).dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultMaleUserProfile),
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Green, 15, 100, ItemCategoryEnum.Top, null).name("AE jacket").description("AE jacket").brand("AE").age(1).material(ItemMaterialEnum.Nylon).style(ItemStyleEnum.Coat_And_Jacket_Light).dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultMaleUserProfile),
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Yellow, 15, 100, ItemCategoryEnum.Top, null).name("Rei jacket").description("Rei jacket").brand("Rei").age(1).material(ItemMaterialEnum.Down).style(ItemStyleEnum.Coat_And_Jacket_Heavy).dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultMaleUserProfile),
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Blue, 70, 120, ItemCategoryEnum.Bottom, null).name("GordonCooper short").description("GordonCooper short").brand("GordonCooper").age(0).material(ItemMaterialEnum.Polyester).style(ItemStyleEnum.Shorts).dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultMaleUserProfile),
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Beige, 70, 120, ItemCategoryEnum.Bottom, null).name("AE short").description("AE short").brand("AE").age(7).material(ItemMaterialEnum.Cotton_Or_Cotton_Blend).style(ItemStyleEnum.Shorts).dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultMaleUserProfile),
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Green, 40, 120, ItemCategoryEnum.Top, null).name("Adidas t-shirt").description("Adidas t-shirt").brand("Adidas").age(0).material(ItemMaterialEnum.Nylon).style(ItemStyleEnum.T_Shirt_Long_Sleeve).dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultMaleUserProfile),
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Blue, 40, 120, ItemCategoryEnum.Top, null).name("Express polo").description("Express polo").brand("Express").age(3).material(ItemMaterialEnum.Cotton_Or_Cotton_Blend).style(ItemStyleEnum.Polo).dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultMaleUserProfile),
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Blue, 70, 120, ItemCategoryEnum.Top, null).name("KennethCole shirt").description("KennethCole shirt").brand("KennethCole").age(4).material(ItemMaterialEnum.Cotton_Or_Cotton_Blend).style(ItemStyleEnum.Dress_Shirt).dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultMaleUserProfile),
	...
	= {
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Green, 0, 0, ItemCategoryEnum.Top, null).name("VS_Tunic_Green").description("VS_Tunic_Green").brand("VS").age(1).material(ItemMaterialEnum.Cotton_Or_Cotton_Blend).style(ItemStyleEnum.Tunic).dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultFemaleUserProfile),
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Violet, 0, 0, ItemCategoryEnum.Top, null).name("JC_Blouse_Sleeveless_Violet").description("JC_Blouse_Sleeveless_Violet").brand("JC").age(1).material(ItemMaterialEnum.Cotton_Or_Cotton_Blend).style(ItemStyleEnum.Blouse_Sleeveless).dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultFemaleUserProfile),
			new ItemData.ItemDataBuilder(null, ItemColorEnum.White, 0, 0, ItemCategoryEnum.Top, null).name("VS_Blouse_Long_Sleeve_White").description("VS_Blouse_Long_Sleeve_White").brand("VS").age(1).material(ItemMaterialEnum.Cotton_Or_Cotton_Blend).style(ItemStyleEnum.Blouse_Long_Sleeve).dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultFemaleUserProfile),
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Multicolor_Pattern, 0, 0, ItemCategoryEnum.Top, null).name("JC_Blouse_Short_Sleeve_Multicolor_Pattern").description("JC_Blouse_Short_Sleeve_Multicolor_Pattern").brand("JC").age(1).material(ItemMaterialEnum.Cotton_Or_Cotton_Blend).style(ItemStyleEnum.Blouse_Short_Sleeve).dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultFemaleUserProfile),
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Pink, 0, 0, ItemCategoryEnum.Top, null).name("Misc_Blouse_Short_Sleeve_Pink").description("Misc_Blouse_Short_Sleeve_Pink").brand("Misc").age(1).material(ItemMaterialEnum.Silk).style(ItemStyleEnum.Blouse_Short_Sleeve).dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultFemaleUserProfile),
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Multicolor_Pattern, 0, 0, ItemCategoryEnum.Top, null).name("BR_Blouse_Long_Sleeve_Multicolor_Pattern").description("BR_Blouse_Long_Sleeve_Multicolor_Pattern").brand("BR").age(1).material(ItemMaterialEnum.Silk).style(ItemStyleEnum.Blouse_Long_Sleeve).dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultFemaleUserProfile),
			...
			new ItemData.ItemDataBuilder(null, ItemColorEnum.White, 0, 0, ItemCategoryEnum.Top, null).name("HM_Collared_And_Button-down_White").description("HM_Collared_And_Button-down_White").brand("HM").age(1).material(ItemMaterialEnum.Cotton_Or_Cotton_Blend).style(ItemStyleEnum.Collared_And_Button_Down).dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultFemaleUserProfile),
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Violet, 0, 0, ItemCategoryEnum.Top, null).name("CK_Party_Top_Violet").description("CK_Party_Top_Violet").brand("CK").age(1).material(ItemMaterialEnum.Nylon).style(ItemStyleEnum.Party_Top).dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultFemaleUserProfile),
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Blue, 0, 0, ItemCategoryEnum.Top, null).name("HM_Collared_And_Button-down_Blue").description("HM_Collared_And_Button-down_Blue").brand("HM").age(1).material(ItemMaterialEnum.Denim).style(ItemStyleEnum.Collared_And_Button_Down).dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultFemaleUserProfile),
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Orange, 0, 0, ItemCategoryEnum.Top, null).name("JC_T-Shirt_Long_Sleeve_Orange").description("JC_T-Shirt_Long_Sleeve_Orange").brand("JC").age(1).material(ItemMaterialEnum.Cotton_Or_Cotton_Blend).style(ItemStyleEnum.T_Shirt_Long_Sleeve).dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultFemaleUserProfile),
			...
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Brown, 0, 0, ItemCategoryEnum.Top, null).name("AP_Coat_And_Jacket_Light_Brown").description("AP_Coat_And_Jacket_Light_Brown").brand("AP").age(1).material(ItemMaterialEnum.Wool_Or_Wool_Blend).style(ItemStyleEnum.Coat_And_Jacket_Light).dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultFemaleUserProfile),
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Beige, 0, 0, ItemCategoryEnum.Top, null).name("BR_Party_Top_Beige").description("BR_Party_Top_Beige").brand("BR").age(1).material(ItemMaterialEnum.Silk).style(ItemStyleEnum.Party_Top).dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultFemaleUserProfile),
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Multicolor_Pattern, 0, 0, ItemCategoryEnum.Top, null).name("UO_Party_Top_Multicolor_Pattern").description("UO_Party_Top_Multicolor_Pattern").brand("UO").age(1).material(ItemMaterialEnum.Cotton_Or_Cotton_Blend).style(ItemStyleEnum.Party_Top).dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultFemaleUserProfile),
			...
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Blue, 0, 0, ItemCategoryEnum.Top, null).name("Guess_Vest_Blue").description("Guess_Vest_Blue").brand("Guess").age(1).material(ItemMaterialEnum.Denim).style(ItemStyleEnum.Vest).dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultFemaleUserProfile),
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Black, 0, 0, ItemCategoryEnum.Top, null).name("AP_T-Shirt_Short_Sleeve_Black").description("AP_T-Shirt_Short_Sleeve_Black").brand("AP").age(1).material(ItemMaterialEnum.Cotton_Or_Cotton_Blend).style(ItemStyleEnum.T_Shirt_Short_Sleeve).dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultFemaleUserProfile),
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Red, 0, 0, ItemCategoryEnum.Top, null).name("AE_Tunic_Red").description("AE_Tunic_Red").brand("AE").age(1).material(ItemMaterialEnum.Nylon).style(ItemStyleEnum.Tunic).dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultFemaleUserProfile),
			...
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Beige, 0, 0, ItemCategoryEnum.Top, null).name("EX_Tunic_Beige").description("EX_Tunic_Beige").brand("EX").age(1).material(ItemMaterialEnum.Cotton_Or_Cotton_Blend).style(ItemStyleEnum.Tunic).dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultFemaleUserProfile),
			...
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Green, 0, 0, ItemCategoryEnum.Top, null).name("Misc_Party_Top_Green").description("Misc_Party_Top_Green").brand("Misc").age(1).material(ItemMaterialEnum.Nylon).style(ItemStyleEnum.Party_Top).dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultFemaleUserProfile),
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Green, 0, 0, ItemCategoryEnum.Top, null).name("UO_Vest_Green").description("UO_Vest_Green").brand("UO").age(1).material(ItemMaterialEnum.Wool_Or_Wool_Blend).style(ItemStyleEnum.Vest).dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultFemaleUserProfile),
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Multicolor_Pattern, 0, 0, ItemCategoryEnum.Top, null).name("BR_T-Shirt_Long_Sleeve_Multicolor_Pattern").description("BR_T-Shirt_Long_Sleeve_Multicolor_Pattern").brand("BR").age(1).material(ItemMaterialEnum.Wool_Or_Wool_Blend).style(ItemStyleEnum.T_Shirt_Long_Sleeve).dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultFemaleUserProfile),
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Gray, 0, 0, ItemCategoryEnum.Top, null).name("OK_Tunic_Gray").description("OK_Tunic_Gray").brand("OK").age(1).material(ItemMaterialEnum.Cotton_Or_Cotton_Blend).style(ItemStyleEnum.Tunic).dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultFemaleUserProfile),
			...
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Blue, 0, 0, ItemCategoryEnum.Bottom, null).name("Misc_Jeans_Blue").description("Misc_Jeans_Blue").brand("Misc").age(1).material(ItemMaterialEnum.Denim).style(ItemStyleEnum.Jeans).dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultFemaleUserProfile),
			...
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Black, 0, 0, ItemCategoryEnum.Bottom, null).name("Misc_Pants_Black").description("Misc_Pants_Black").brand("Misc").age(1).material(ItemMaterialEnum.Wool_Or_Wool_Blend).style(ItemStyleEnum.Pants).dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultFemaleUserProfile),
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Blue, 0, 0, ItemCategoryEnum.Bottom, null).name("BR_Skirts_Blue").description("BR_Skirts_Blue").brand("BR").age(1).material(ItemMaterialEnum.Denim).style(ItemStyleEnum.Skirts).dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultFemaleUserProfile),
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Orange, 0, 0, ItemCategoryEnum.Bottom, null).name("JC_Pants_Orange").description("JC_Pants_Orange").brand("JC").age(1).material(ItemMaterialEnum.Nylon).style(ItemStyleEnum.Pants).dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultFemaleUserProfile),
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Black, 0, 0, ItemCategoryEnum.Bottom, null).name("Misc_Skirts_Black").description("Misc_Skirts_Black").brand("Misc").age(1).material(ItemMaterialEnum.Wool_Or_Wool_Blend).style(ItemStyleEnum.Skirts).dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultFemaleUserProfile),
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Blue, 0, 0, ItemCategoryEnum.Bottom, null).name("Loft_Skirts_Blue").description("Loft_Skirts_Blue").brand("Loft").age(1).material(ItemMaterialEnum.Nylon).style(ItemStyleEnum.Skirts).dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultFemaleUserProfile),
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Blue, 0, 0, ItemCategoryEnum.Bottom, null).name("EX_Skirts_Blue").description("EX_Skirts_Blue").brand("EX").age(1).material(ItemMaterialEnum.Denim).style(ItemStyleEnum.Skirts).dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultFemaleUserProfile),
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Black, 0, 0, ItemCategoryEnum.Bottom, null).name("AP_Skirts_Black").description("AP_Skirts_Black").brand("AP").age(1).material(ItemMaterialEnum.Cotton_Or_Cotton_Blend).style(ItemStyleEnum.Skirts).dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultFemaleUserProfile),
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Beige, 0, 0, ItemCategoryEnum.Bottom, null).name("Loft_Pants_Beige").description("Loft_Pants_Beige").brand("Loft").age(1).material(ItemMaterialEnum.Cotton_Or_Cotton_Blend).style(ItemStyleEnum.Pants).dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultFemaleUserProfile),
			...
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Blue, 0, 0, ItemCategoryEnum.Bottom, null).name("EX_Jeans_Blue").description("EX_Jeans_Blue").brand("EX").age(1).material(ItemMaterialEnum.Denim).style(ItemStyleEnum.Jeans).dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultFemaleUserProfile),
			...
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Gray, 0, 0, ItemCategoryEnum.Bottom, null).name("BR_Pants_Gray").description("BR_Pants_Gray").brand("BR").age(1).material(ItemMaterialEnum.Cotton_Or_Cotton_Blend).style(ItemStyleEnum.Pants).dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultFemaleUserProfile),
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Brown, 0, 0, ItemCategoryEnum.Bottom, null).name("BR_Pants_Brown").description("BR_Pants_Brown").brand("BR").age(1).material(ItemMaterialEnum.Cotton_Or_Cotton_Blend).style(ItemStyleEnum.Pants).dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultFemaleUserProfile),
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Black, 0, 0, ItemCategoryEnum.Bottom, null).name("BCBG_Pants_Black").description("BCBG_Pants_Black").brand("BCBG").age(1).material(ItemMaterialEnum.Polyester).style(ItemStyleEnum.Pants).dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultFemaleUserProfile),
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Beige, 0, 0, ItemCategoryEnum.Bottom, null).name("BR_Pants_Beige").description("BR_Pants_Beige").brand("BR").age(1).material(ItemMaterialEnum.Cotton_Or_Cotton_Blend).style(ItemStyleEnum.Pants).dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultFemaleUserProfile),
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Black, 0, 0, ItemCategoryEnum.Bottom, null).name("EX_Pants_Black").description("EX_Pants_Black").brand("EX").age(1).material(ItemMaterialEnum.Wool_Or_Wool_Blend).style(ItemStyleEnum.Pants).dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultFemaleUserProfile),
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Green, 0, 0, ItemCategoryEnum.Bottom, null).name("VS_Pants_Green").description("VS_Pants_Green").brand("VS").age(1).material(ItemMaterialEnum.Linen).style(ItemStyleEnum.Pants).dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultFemaleUserProfile),
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Black, 0, 0, ItemCategoryEnum.Top, null).name("EX_Blouse_Long_Sleeve_Black").description("EX_Blouse_Long_Sleeve_Black").brand("EX").age(1).material(ItemMaterialEnum.Nylon).style(ItemStyleEnum.Blouse_Long_Sleeve).dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultFemaleUserProfile),
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Multicolor_Pattern, 0, 0, ItemCategoryEnum.Top, null).name("Misc_Collared_And_Button-down_Multicolor_Pattern").description("Misc_Collared_And_Button-down_Multicolor_Pattern").brand("Misc").age(1).material(ItemMaterialEnum.Polyester).style(ItemStyleEnum.Collared_And_Button_Down).dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultFemaleUserProfile),
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Black, 0, 0, ItemCategoryEnum.Top, null).name("EX_Coat_And_Jacket_Light_Black").description("EX_Coat_And_Jacket_Light_Black").brand("EX").age(1).material(ItemMaterialEnum.Polyester).style(ItemStyleEnum.Coat_And_Jacket_Light).dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultFemaleUserProfile),
			...
			new ItemData.ItemDataBuilder(null, ItemColorEnum.White, 0, 0, ItemCategoryEnum.Top, null).name("VS_Tunic_White").description("VS_Tunic_White").brand("VS").age(1).material(ItemMaterialEnum.Cotton_Or_Cotton_Blend).style(ItemStyleEnum.Tunic).dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultFemaleUserProfile),
