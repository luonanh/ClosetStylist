...
public class ItemDatabaseHelper {
	...
	= {
		// String imageLink (null), String color, int tempMin, int tempMax, String category, String cropImageLink (null)
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Blue, 15, 100, ItemCategoryEnum.Bottom, null).name("Banana jean").description("Banana jean").brand("Banana").age(1).material("Denim").style("Jeans").dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultMaleUserProfile),
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Blue, 40, 120, ItemCategoryEnum.Top, null).name("Express polo").description("Express polo").brand("Express").age(2).material("Cotton_Or_Cotton_Blend").style("Polo").dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultMaleUserProfile),
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Multicolor_Pattern, 70, 120, ItemCategoryEnum.Bottom, null).name("DKNY short").description("DKNY short").brand("DKNY").age(1).material("Polyester").style("Shorts").dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultMaleUserProfile),
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Green, 70, 120, ItemCategoryEnum.Bottom, null).name("FrenchConnection short").description("FrenchConnection short").brand("FrenchConnection").age(3).material("Cotton_Or_Cotton_Blend").style("Shorts").dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultMaleUserProfile),
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Multicolor_Pattern, 70, 120, ItemCategoryEnum.Top, null).name("AE t-shirt").description("AE t-shirt").brand("AE").age(2).material("Cotton_Or_Cotton_Blend").style("T-Shirt_Short_Sleeve").dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultMaleUserProfile),
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Yellow, 70, 120, ItemCategoryEnum.Top,null).name("JCrew t-shirt").description("JCrew t-shirt").brand("JCrew").age(1).material("Cotton_Or_Cotton_Blend").style("T-Shirt_Short_Sleeve").dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultMaleUserProfile),
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Blue, 15, 100, ItemCategoryEnum.Bottom, null).name("Arizona jean").description("Arizona jean").brand("Arizona").age(5).material("Denim").style("Jeans").dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultMaleUserProfile),
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Brown, 15, 100, ItemCategoryEnum.Bottom, null).name("Aeropostale pants").description("Aeropostale pants").brand("Aeropostale").age(4).material("Cotton_Or_Cotton_Blend").style("Pants").dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultMaleUserProfile),
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Beige, 15, 100, ItemCategoryEnum.Bottom, null).name("Dockers pants").description("Dockers pants").brand("Dockers").age(3).material("Cotton_Or_Cotton_Blend").style("Pants").dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultMaleUserProfile),
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Multicolor_Pattern, 15, 100, ItemCategoryEnum.Top, null).name("Adidas jacket").description("Adidas jacket").brand("Adidas").age(1).material("Polyester").style("Coat_And_Jacket_Light").dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultMaleUserProfile),
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Green, 15, 100, ItemCategoryEnum.Top, null).name("AE jacket").description("AE jacket").brand("AE").age(1).material("Nylon").style("Coat_And_Jacket_Light").dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultMaleUserProfile),
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Yellow, 15, 100, ItemCategoryEnum.Top, null).name("Rei jacket").description("Rei jacket").brand("Rei").age(1).material("Down").style("Coat_And_Jacket_Heavy").dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultMaleUserProfile),
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Blue, 70, 120, ItemCategoryEnum.Bottom, null).name("GordonCooper short").description("GordonCooper short").brand("GordonCooper").age(0).material("Polyester").style("Shorts").dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultMaleUserProfile),
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Beige, 70, 120, ItemCategoryEnum.Bottom, null).name("AE short").description("AE short").brand("AE").age(7).material("Cotton_Or_Cotton_Blend").style("Shorts").dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultMaleUserProfile),
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Green, 40, 120, ItemCategoryEnum.Top, null).name("Adidas t-shirt").description("Adidas t-shirt").brand("Adidas").age(0).material("Nylon").style("T-Shirt_Long_Sleeve").dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultMaleUserProfile),
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Blue, 40, 120, ItemCategoryEnum.Top, null).name("Express polo").description("Express polo").brand("Express").age(3).material("Cotton_Or_Cotton_Blend").style("Polo").dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultMaleUserProfile),
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Blue, 70, 120, ItemCategoryEnum.Top, null).name("KennethCole shirt").description("KennethCole shirt").brand("KennethCole").age(4).material("Cotton_Or_Cotton_Blend").style("Dress_Shirt").dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultMaleUserProfile),
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Multicolor_Pattern, 70, 120, ItemCategoryEnum.Top, null).name("RalphLauren shirt").description("RalphLauren shirt").brand("RalphLauren").age(9).material("Cotton_Or_Cotton_Blend").style("Dress_Shirt").dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultMaleUserProfile),
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Multicolor_Pattern, 70, 120, ItemCategoryEnum.Top, null).name("Diesel shirt").description("Diesel shirt").brand("Diesel").age(7).material("Cotton_Or_Cotton_Blend").style("Casual_Button_Down_Shirt").dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultMaleUserProfile),
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Multicolor_Pattern, 70, 120, ItemCategoryEnum.Top, null).name("AE shirt").description("AE shirt").brand("AE").age(6).material("Cotton_Or_Cotton_Blend").style("Casual_Button_Down_Shirt").dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultMaleUserProfile)
	};
	...
	= {
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Green, 0, 0, ItemCategoryEnum.Top, null).name("VS_Tunic_Green").description("VS_Tunic_Green").brand("VS").age(1).material("Cotton_Or_Cotton_Blend").style("Tunic").dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultFemaleUserProfile),
			...
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Pink, 0, 0, ItemCategoryEnum.Top, null).name("Misc_Blouse_Short_Sleeve_Pink").description("Misc_Blouse_Short_Sleeve_Pink").brand("Misc").age(1).material("Silk").style("Blouse_Short_Sleeve").dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultFemaleUserProfile),
			...
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Violet, 0, 0, ItemCategoryEnum.Top, null).name("CK_Party_Top_Violet").description("CK_Party_Top_Violet").brand("CK").age(1).material("Nylon").style("Party_Top").dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultFemaleUserProfile),
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Blue, 0, 0, ItemCategoryEnum.Top, null).name("HM_Collared_And_Button-down_Blue").description("HM_Collared_And_Button-down_Blue").brand("HM").age(1).material("Denim").style("Collared_And_Button-down").dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultFemaleUserProfile),
			...
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Brown, 0, 0, ItemCategoryEnum.Top, null).name("AP_Coat_And_Jacket_Light_Brown").description("AP_Coat_And_Jacket_Light_Brown").brand("AP").age(1).material("Wool_Or_Wool_Blend").style("Coat_And_Jacket_Light").dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultFemaleUserProfile),
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Beige, 0, 0, ItemCategoryEnum.Top, null).name("BR_Party_Top_Beige").description("BR_Party_Top_Beige").brand("BR").age(1).material("Silk").style("Party_Top").dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultFemaleUserProfile),
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Multicolor_Pattern, 0, 0, ItemCategoryEnum.Top, null).name("UO_Party_Top_Multicolor_Pattern").description("UO_Party_Top_Multicolor_Pattern").brand("UO").age(1).material("Cotton_Or_Cotton_Blend").style("Party_Top").dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultFemaleUserProfile),
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Violet, 0, 0, ItemCategoryEnum.Top, null).name("JC_Cardigan_Violet").description("JC_Cardigan_Violet").brand("JC").age(1).material("Cotton_Or_Cotton_Blend").style("Cardigan").dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultFemaleUserProfile),
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Blue, 0, 0, ItemCategoryEnum.Top, null).name("Guess_Vest_Blue").description("Guess_Vest_Blue").brand("Guess").age(1).material("Denim").style("Vest").dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultFemaleUserProfile),
			...
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Red, 0, 0, ItemCategoryEnum.Top, null).name("AE_Tunic_Red").description("AE_Tunic_Red").brand("AE").age(1).material("Nylon").style("Tunic").dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultFemaleUserProfile),
			...
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Black, 0, 0, ItemCategoryEnum.Top, null).name("ON_Blouse_Sleeveless_Black").description("ON_Blouse_Sleeveless_Black").brand("ON").age(1).material("Silk").style("Blouse_Sleeveless").dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultFemaleUserProfile),
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Blue, 0, 0, ItemCategoryEnum.Top, null).name("UO_Party_Top_Blue").description("UO_Party_Top_Blue").brand("UO").age(1).material("Cotton_Or_Cotton_Blend").style("Party_Top").dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultFemaleUserProfile),
			...
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Beige, 0, 0, ItemCategoryEnum.Top, null).name("EX_Tunic_Beige").description("EX_Tunic_Beige").brand("EX").age(1).material("Cotton_Or_Cotton_Blend").style("Tunic").dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultFemaleUserProfile),
			...
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Black, 0, 0, ItemCategoryEnum.Top, null).name("KC_Blouse_Sleeveless_Black").description("KC_Blouse_Sleeveless_Black").brand("KC").age(1).material("Polyester").style("Blouse_Sleeveless").dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultFemaleUserProfile),
			...
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Pink, 0, 0, ItemCategoryEnum.Top, null).name("BR_Blouse_Sleeveless_Pink").description("BR_Blouse_Sleeveless_Pink").brand("BR").age(1).material("Polyester").style("Blouse_Sleeveless").dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultFemaleUserProfile),
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Green, 0, 0, ItemCategoryEnum.Top, null).name("Misc_Party_Top_Green").description("Misc_Party_Top_Green").brand("Misc").age(1).material("Nylon").style("Party_Top").dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultFemaleUserProfile),
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Green, 0, 0, ItemCategoryEnum.Top, null).name("UO_Vest_Green").description("UO_Vest_Green").brand("UO").age(1).material("Wool_Or_Wool_Blend").style("Vest").dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultFemaleUserProfile),
			...
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Gray, 0, 0, ItemCategoryEnum.Top, null).name("OK_Tunic_Gray").description("OK_Tunic_Gray").brand("OK").age(1).material("Cotton_Or_Cotton_Blend").style("Tunic").dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultFemaleUserProfile),
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Yellow, 0, 0, ItemCategoryEnum.Top, null).name("Misc_Cardigan_Yellow").description("Misc_Cardigan_Yellow").brand("Misc").age(1).material("Wool_Or_Wool_Blend").style("Cardigan").dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultFemaleUserProfile),
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Black, 0, 0, ItemCategoryEnum.Top, null).name("JC_Cardigan_Black").description("JC_Cardigan_Black").brand("JC").age(1).material("Wool_Or_Wool_Blend").style("Cardigan").dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultFemaleUserProfile),
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Orange, 0, 0, ItemCategoryEnum.Top, null).name("BR_Blouse_Sleeveless_Orange").description("BR_Blouse_Sleeveless_Orange").brand("BR").age(1).material("Polyester").style("Blouse_Sleeveless").dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultFemaleUserProfile),
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Black, 0, 0, ItemCategoryEnum.Top, null).name("KC_Coat_And_Jacket_Light_Black").description("KC_Coat_And_Jacket_Light_Black").brand("KC").age(1).material("Nylon").style("Coat_And_Jacket_Light").dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultFemaleUserProfile),
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Beige, 0, 0, ItemCategoryEnum.Bottom, null).name("Guess_Legging_Skinny_Beige").description("Guess_Legging_Skinny_Beige").brand("Guess").age(1).material("Denim").style("Legging_Skinny").dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultFemaleUserProfile),
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Blue, 0, 0, ItemCategoryEnum.Bottom, null).name("Misc_Jeans_Blue").description("Misc_Jeans_Blue").brand("Misc").age(1).material("Denim").style("Jeans").dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultFemaleUserProfile),
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Multicolor_Pattern, 0, 0, ItemCategoryEnum.Bottom, null).name("LV_Legging_Skinny_Multicolor_Pattern").description("LV_Legging_Skinny_Multicolor_Pattern").brand("LV").age(1).material("Denim").style("Legging_Skinny").dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultFemaleUserProfile),
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Black, 0, 0, ItemCategoryEnum.Bottom, null).name("Misc_Pants_Black").description("Misc_Pants_Black").brand("Misc").age(1).material("Wool_Or_Wool_Blend").style("Pants").dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultFemaleUserProfile),
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Blue, 0, 0, ItemCategoryEnum.Bottom, null).name("BR_Skirts_Blue").description("BR_Skirts_Blue").brand("BR").age(1).material("Denim").style("Skirts").dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultFemaleUserProfile),
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Orange, 0, 0, ItemCategoryEnum.Bottom, null).name("JC_Pants_Orange").description("JC_Pants_Orange").brand("JC").age(1).material("Nylon").style("Pants").dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultFemaleUserProfile),
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Black, 0, 0, ItemCategoryEnum.Bottom, null).name("Misc_Skirts_Black").description("Misc_Skirts_Black").brand("Misc").age(1).material("Wool_Or_Wool_Blend").style("Skirts").dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultFemaleUserProfile),
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Blue, 0, 0, ItemCategoryEnum.Bottom, null).name("Loft_Skirts_Blue").description("Loft_Skirts_Blue").brand("Loft").age(1).material("Nylon").style("Skirts").dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultFemaleUserProfile),
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Blue, 0, 0, ItemCategoryEnum.Bottom, null).name("EX_Skirts_Blue").description("EX_Skirts_Blue").brand("EX").age(1).material("Denim").style("Skirts").dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultFemaleUserProfile),
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Black, 0, 0, ItemCategoryEnum.Bottom, null).name("AP_Skirts_Black").description("AP_Skirts_Black").brand("AP").age(1).material("Cotton_Or_Cotton_Blend").style("Skirts").dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultFemaleUserProfile),
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Beige, 0, 0, ItemCategoryEnum.Bottom, null).name("Loft_Pants_Beige").description("Loft_Pants_Beige").brand("Loft").age(1).material("Cotton_Or_Cotton_Blend").style("Pants").dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultFemaleUserProfile),
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Blue, 0, 0, ItemCategoryEnum.Bottom, null).name("EX_Legging_Skinny_Blue").description("EX_Legging_Skinny_Blue").brand("EX").age(1).material("Denim").style("Legging_Skinny").dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultFemaleUserProfile),
			new ItemData.ItemDataBuilder(null, ItemColorEnum.White, 0, 0, ItemCategoryEnum.Bottom, null).name("Guess_Legging_Skinny_White").description("Guess_Legging_Skinny_White").brand("Guess").age(1).material("Denim").style("Legging_Skinny").dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultFemaleUserProfile),
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Blue, 0, 0, ItemCategoryEnum.Bottom, null).name("EX_Jeans_Blue").description("EX_Jeans_Blue").brand("EX").age(1).material("Denim").style("Jeans").dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultFemaleUserProfile),
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Orange, 0, 0, ItemCategoryEnum.Bottom, null).name("Guess_Legging_Skinny_Orange").description("Guess_Legging_Skinny_Orange").brand("Guess").age(1).material("Spandex").style("Legging_Skinny").dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultFemaleUserProfile),
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Gray, 0, 0, ItemCategoryEnum.Bottom, null).name("BR_Pants_Gray").description("BR_Pants_Gray").brand("BR").age(1).material("Cotton_Or_Cotton_Blend").style("Pants").dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultFemaleUserProfile),
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Brown, 0, 0, ItemCategoryEnum.Bottom, null).name("BR_Pants_Brown").description("BR_Pants_Brown").brand("BR").age(1).material("Cotton_Or_Cotton_Blend").style("Pants").dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultFemaleUserProfile),
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Black, 0, 0, ItemCategoryEnum.Bottom, null).name("BCBG_Pants_Black").description("BCBG_Pants_Black").brand("BCBG").age(1).material("Polyester").style("Pants").dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultFemaleUserProfile),
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Beige, 0, 0, ItemCategoryEnum.Bottom, null).name("BR_Pants_Beige").description("BR_Pants_Beige").brand("BR").age(1).material("Cotton_Or_Cotton_Blend").style("Pants").dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultFemaleUserProfile),
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Black, 0, 0, ItemCategoryEnum.Bottom, null).name("EX_Pants_Black").description("EX_Pants_Black").brand("EX").age(1).material("Wool_Or_Wool_Blend").style("Pants").dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultFemaleUserProfile),
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Green, 0, 0, ItemCategoryEnum.Bottom, null).name("VS_Pants_Green").description("VS_Pants_Green").brand("VS").age(1).material("Linen").style("Pants").dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultFemaleUserProfile),
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Black, 0, 0, ItemCategoryEnum.Top, null).name("EX_Blouse_Long_Sleeve_Black").description("EX_Blouse_Long_Sleeve_Black").brand("EX").age(1).material("Nylon").style("Blouse_Long_Sleeve").dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultFemaleUserProfile),
			...
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Black, 0, 0, ItemCategoryEnum.Top, null).name("EX_Coat_And_Jacket_Light_Black").description("EX_Coat_And_Jacket_Light_Black").brand("EX").age(1).material("Polyester").style("Coat_And_Jacket_Light").dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultFemaleUserProfile),
			new ItemData.ItemDataBuilder(null, ItemColorEnum.White, 0, 0, ItemCategoryEnum.Top, null).name("AF_Coat_And_Jacket_Heavy_White").description("AF_Coat_And_Jacket_Heavy_White").brand("AF").age(1).material("Down").style("Coat_And_Jacket_Heavy").dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultFemaleUserProfile),
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Blue, 0, 0, ItemCategoryEnum.Top, null).name("KC_Coat_And_Jacket_Heavy_Blue").description("KC_Coat_And_Jacket_Heavy_Blue").brand("KC").age(1).material("Down").style("Coat_And_Jacket_Heavy").dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultFemaleUserProfile),
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Orange, 0, 0, ItemCategoryEnum.Top, null).name("NF_Coat_And_Jacket_Heavy_Orange").description("NF_Coat_And_Jacket_Heavy_Orange").brand("NF").age(1).material("Down").style("Coat_And_Jacket_Heavy").dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultFemaleUserProfile),
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Beige, 0, 0, ItemCategoryEnum.Top, null).name("EX_Coat_And_Jacket_Heavy_Beige").description("EX_Coat_And_Jacket_Heavy_Beige").brand("EX").age(1).material("Leather").style("Coat_And_Jacket_Heavy").dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultFemaleUserProfile),
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Green, 0, 0, ItemCategoryEnum.Top, null).name("BR_Coat_And_Jacket_Heavy_Green").description("BR_Coat_And_Jacket_Heavy_Green").brand("BR").age(1).material("Nylon").style("Coat_And_Jacket_Heavy").dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultFemaleUserProfile),
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Brown, 0, 0, ItemCategoryEnum.Top, null).name("EX_Coat_And_Jacket_Heavy_Brown").description("EX_Coat_And_Jacket_Heavy_Brown").brand("EX").age(1).material("Nylon").style("Coat_And_Jacket_Heavy").dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultFemaleUserProfile),
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Yellow, 0, 0, ItemCategoryEnum.Top, null).name("AP_Coat_And_Jacket_Light_Yellow").description("AP_Coat_And_Jacket_Light_Yellow").brand("AP").age(1).material("Polyester").style("Coat_And_Jacket_Light").dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultFemaleUserProfile),
			...
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Blue, 0, 0, ItemCategoryEnum.Top, null).name("EX_Blouse_Sleeveless_Blue").description("EX_Blouse_Sleeveless_Blue").brand("EX").age(1).material("Denim").style("Blouse_Sleeveless").dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultFemaleUserProfile),
			new ItemData.ItemDataBuilder(null, ItemColorEnum.White, 0, 0, ItemCategoryEnum.Top, null).name("EX_Cardigan_White").description("EX_Cardigan_White").brand("EX").age(1).material("Wool_Or_Wool_Blend").style("Cardigan").dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultFemaleUserProfile),
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Brown, 0, 0, ItemCategoryEnum.Top, null).name("EX_Blouse_Long_Sleeve_Brown").description("EX_Blouse_Long_Sleeve_Brown").brand("EX").age(1).material("Wool_Or_Wool_Blend").style("Blouse_Long_Sleeve").dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultFemaleUserProfile),
			new ItemData.ItemDataBuilder(null, ItemColorEnum.White, 0, 0, ItemCategoryEnum.Top, null).name("EX_Coat_And_Jacket_Light_White").description("EX_Coat_And_Jacket_Light_White").brand("EX").age(1).material("Nylon").style("Coat_And_Jacket_Light").dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultFemaleUserProfile),
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Beige, 0, 0, ItemCategoryEnum.Top, null).name("EX_Blouse_Long_Sleeve_Beige").description("EX_Blouse_Long_Sleeve_Beige").brand("EX").age(1).material("Wool_Or_Wool_Blend").style("Blouse_Long_Sleeve").dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultFemaleUserProfile),
			...
			new ItemData.ItemDataBuilder(null, ItemColorEnum.White, 0, 0, ItemCategoryEnum.Top, null).name("VS_Tunic_White").description("VS_Tunic_White").brand("VS").age(1).material("Cotton_Or_Cotton_Blend").style("Tunic").dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultFemaleUserProfile),
			...
			new ItemData.ItemDataBuilder(null, ItemColorEnum.Blue, 0, 0, ItemCategoryEnum.Top, null).name("VS_Tank_Camisoles_Blue").description("VS_Tank_Camisoles_Blue").brand("VS").age(1).material("Wool_Or_Wool_Blend").style("Tank_Camisoles").dirty(false).wornTime(0).maxWornTime(1).buildByGender(defaultFemaleUserProfile)
	};
